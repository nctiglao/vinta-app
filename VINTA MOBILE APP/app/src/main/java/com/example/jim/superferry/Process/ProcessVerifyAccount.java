...
import com.example.jim.superferry.activity.SendVerify;
...
public class ProcessVerifyAccount extends AsyncTask<String, String, String> {
    ...
    public ProcessVerifyAccount(Activity activity, EditText emailEditText, EditText passEditText, EditText mobileEditText, String android_id) {
            ...
            if (result.equals("no result")) {
                ...
                try {
                    ...
                    if (status.equals("200")) {
                        ...
                        Intent intent = new Intent(activity, SendVerify.class);
