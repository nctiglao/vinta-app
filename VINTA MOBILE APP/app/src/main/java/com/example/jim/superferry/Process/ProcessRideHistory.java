...
public class ProcessRideHistory extends AsyncTask<String, String, String> {
    ...
    public ProcessRideHistory(Activity activity,SharedPreferences sharedPreferences ,RideHistoryAdapter rideHistoryAdapter, ListView listView){

        this.activity = activity;
        this.rideHistoryAdapter = rideHistoryAdapter;
        ...
        if (result.equalsIgnoreCase("exception") || result.equalsIgnoreCase("unsuccessful")) {
            ...
            if (result.equals("no result")) {
                ...
                try {
                    ...
                    int i = 0;
                    String id, origin, destination, date;
                    while (i<jArray.length()) {
                        ...
                        RideHistory rideHistory = new RideHistory(id, origin, destination,date);

                        rideHistoryAdapter.add(rideHistory);
