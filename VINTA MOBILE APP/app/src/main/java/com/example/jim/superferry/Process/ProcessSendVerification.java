...
public class ProcessSendVerification extends AsyncTask<String, String, String> {
    ...
    public ProcessSendVerification(Activity activity, String email, String pass_id, String mobile,String android_id ,EditText codeEdit){
    ...
    protected String doInBackground(String... params) {
        try {
            url = new java.net.URL(Constants.VERIFY_CODE);
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder() .
                    ...
                    .appendQueryParameter("code", params[4]);
