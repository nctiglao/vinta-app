...
import com.example.jim.superferry.activity.VerifyCode;
...
public class ProcessForgetPass extends AsyncTask<String, String, String> {
    ...
    public ProcessForgetPass(Activity activity, EditText user){
            ...
            if(result.equals("no result")){
                ...
                try {
                    ...
                    if (status.equals("200")){
                        ...
                        Intent intent = new Intent(activity, VerifyCode.class);
